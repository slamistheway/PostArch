...
const versions_cjs_1 = require("./versions.cjs");
    ...
    return (0, schematics_1.chain)([
        (tree, context) => {
            (0, dependencies_1.addPackageJsonDependency)(tree, {
                ...
                version: versions_cjs_1.angularFontawesomeVersion,
            });
            ...
            for (const pack of iconPackages) {
                (0, dependencies_1.addPackageJsonDependency)(tree, {
                    ...
                    version: versions_cjs_1.iconPackVersionMap[options.version].iconPackVersion,
                });
            }
