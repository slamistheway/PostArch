...
import { Injectable, input, effect, Directive, computed, ChangeDetectionStrategy, Component, model, inject, CSP_NONCE, DOCUMENT, NgModule } from '@angular/core';
...
class FaConfig {
    ...
    _autoAddCss = true;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaConfig, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaConfig, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaConfig, decorators: [{
            type: Injectable,
...
class FaIconLibrary {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaIconLibrary, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaIconLibrary, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaIconLibrary, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }] });
 ...
 */
function ensureCss(document, config, nonce) {
...
class FaStackItemSizeDirective {
     ...
     */
    stackItemSize = input('1x', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "stackItemSize" }] : /* istanbul ignore next */ []));
    /**
     * @internal
     */
    ...
    ...(ngDevMode ? [{ debugName: "_effect" }] : /* istanbul ignore next */ []));
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaStackItemSizeDirective, deps: [], target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.0.5", type: FaStackItemSizeDirective, isStandalone: true, selector: "fa-icon[stackItemSize],fa-duotone-icon[stackItemSize]", inputs: { stackItemSize: { classPropertyName: "stackItemSize", publicName: "stackItemSize", isSignal: true, isRequired: false, transformFunction: null }, size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null } }, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaStackItemSizeDirective, decorators: [{
            type: Directive,
            args: [{
                    // eslint-disable-next-line @angular-eslint/directive-selector
                    selector: 'fa-icon[stackItemSize],fa-duotone-icon[stackItemSize]',
                }]
        }], propDecorators: { stackItemSize: [{ type: i0.Input, args: [{ isSignal: true, alias: "stackItemSize", required: false }] }], size: [{ type: i0.Input, args: [{ isSignal: true, alias: "size", required: false }] }] } });
...
class FaStackComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaStackComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.0.5", type: FaStackComponent, isStandalone: true, selector: "fa-stack", inputs: { size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "classes()" } }, ngImport: i0, template: `<ng-content />`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaStackComponent, decorators: [{
            type: Component,
            args: [{
                    selector: 'fa-stack',
                    template: `<ng-content />`,
...
class FaIconComponent {
     ...
     */
    animation = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "animation" }] : /* istanbul ignore next */ []));
    mask = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "mask" }] : /* istanbul ignore next */ []));
    flip = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "flip" }] : /* istanbul ignore next */ []));
    size = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "size" }] : /* istanbul ignore next */ []));
    pull = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "pull" }] : /* istanbul ignore next */ []));
    border = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "border" }] : /* istanbul ignore next */ []));
    inverse = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "inverse" }] : /* istanbul ignore next */ []));
    symbol = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "symbol" }] : /* istanbul ignore next */ []));
    rotate = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "rotate" }] : /* istanbul ignore next */ []));
    fixedWidth = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "fixedWidth" }] : /* istanbul ignore next */ []));
    transform = model(/* @ts-ignore */
     ...
     * @default 'img'
     */
    a11yRole = model(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "a11yRole" }] : /* istanbul ignore next */ []));
    ...
    ...(ngDevMode ? [{ debugName: "renderedIconHTML" }] : /* istanbul ignore next */ []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaIconComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { icon: [{ type: i0.Input, args: [{ isSignal: true, alias: "icon", required: false }] }, { type: i0.Output, args: ["iconChange"] }], title: [{ type: i0.Input, args: [{ isSignal: true, alias: "title", required: false }] }, { type: i0.Output, args: ["titleChange"] }], animation: [{ type: i0.Input, args: [{ isSignal: true, alias: "animation", required: false }] }, { type: i0.Output, args: ["animationChange"] }], mask: [{ type: i0.Input, args: [{ isSignal: true, alias: "mask", required: false }] }, { type: i0.Output, args: ["maskChange"] }], flip: [{ type: i0.Input, args: [{ isSignal: true, alias: "flip", required: false }] }, { type: i0.Output, args: ["flipChange"] }], size: [{ type: i0.Input, args: [{ isSignal: true, alias: "size", required: false }] }, { type: i0.Output, args: ["sizeChange"] }], pull: [{ type: i0.Input, args: [{ isSignal: true, alias: "pull", required: false }] }, { type: i0.Output, args: ["pullChange"] }], border: [{ type: i0.Input, args: [{ isSignal: true, alias: "border", required: false }] }, { type: i0.Output, args: ["borderChange"] }], inverse: [{ type: i0.Input, args: [{ isSignal: true, alias: "inverse", required: false }] }, { type: i0.Output, args: ["inverseChange"] }], symbol: [{ type: i0.Input, args: [{ isSignal: true, alias: "symbol", required: false }] }, { type: i0.Output, args: ["symbolChange"] }], rotate: [{ type: i0.Input, args: [{ isSignal: true, alias: "rotate", required: false }] }, { type: i0.Output, args: ["rotateChange"] }], fixedWidth: [{ type: i0.Input, args: [{ isSignal: true, alias: "fixedWidth", required: false }] }, { type: i0.Output, args: ["fixedWidthChange"] }], transform: [{ type: i0.Input, args: [{ isSignal: true, alias: "transform", required: false }] }, { type: i0.Output, args: ["transformChange"] }], a11yRole: [{ type: i0.Input, args: [{ isSignal: true, alias: "a11yRole", required: false }] }, { type: i0.Output, args: ["a11yRoleChange"] }] } });
...
class FaDuotoneIconComponent extends FaIconComponent {
     ...
     * @default false
     */
    swapOpacity = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "swapOpacity" }] : /* istanbul ignore next */ []));
    /**
     ...
     * @default 1.0
     */
    primaryOpacity = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "primaryOpacity" }] : /* istanbul ignore next */ []));
    /**
     ...
     * @default 0.4
     */
    secondaryOpacity = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "secondaryOpacity" }] : /* istanbul ignore next */ []));
    /**
     ...
     */
    primaryColor = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "primaryColor" }] : /* istanbul ignore next */ []));
    /**
     ...
     * @default CSS inherited color
     */
    secondaryColor = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "secondaryColor" }] : /* istanbul ignore next */ []));
    findIconDefinition(i) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaDuotoneIconComponent, decorators: [{
        ...
        }], propDecorators: { swapOpacity: [{ type: i0.Input, args: [{ isSignal: true, alias: "swapOpacity", required: false }] }], primaryOpacity: [{ type: i0.Input, args: [{ isSignal: true, alias: "primaryOpacity", required: false }] }], secondaryOpacity: [{ type: i0.Input, args: [{ isSignal: true, alias: "secondaryOpacity", required: false }] }], primaryColor: [{ type: i0.Input, args: [{ isSignal: true, alias: "primaryColor", required: false }] }], secondaryColor: [{ type: i0.Input, args: [{ isSignal: true, alias: "secondaryColor", required: false }] }] } });
...
class FaLayersComponent {
    size = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "size" }] : /* istanbul ignore next */ []));
    fixedWidth = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "fixedWidth" }] : /* istanbul ignore next */ []));
    faFw = computed(() => {
        const fixedWidth = this.fixedWidth();
        return typeof fixedWidth === 'boolean' ? fixedWidth : this.config.fixedWidth;
    }, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "faFw" }] : /* istanbul ignore next */ []));
    classes = computed(() => {
        const sizeValue = this.size();
        const sizeClass = sizeValue ? { [`fa-${sizeValue}`]: true } : {};
        return {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaLayersComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.0.5", type: FaLayersComponent, isStandalone: true, selector: "fa-layers", inputs: { size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null }, fixedWidth: { classPropertyName: "fixedWidth", publicName: "fixedWidth", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "classes()" } }, ngImport: i0, template: `<ng-content />`, isInline: true, changeDetection: i0.ChangeDetectionStrategy.OnPush });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaLayersComponent, decorators: [{
            type: Component,
            args: [{
                    selector: 'fa-layers',
                    template: `<ng-content />`,
        ...
        }], propDecorators: { size: [{ type: i0.Input, args: [{ isSignal: true, alias: "size", required: false }] }], fixedWidth: [{ type: i0.Input, args: [{ isSignal: true, alias: "fixedWidth", required: false }] }] } });
...
class FaLayersCounterComponent {
    ...
    ...(ngDevMode ? [{ debugName: "renderedHTML" }] : /* istanbul ignore next */ []));
    cspNonce = inject(CSP_NONCE);
    document = inject(DOCUMENT);
    config = inject(FaConfig);
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaLayersCounterComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { content: [{ type: i0.Input, args: [{ isSignal: true, alias: "content", required: true }] }], title: [{ type: i0.Input, args: [{ isSignal: true, alias: "title", required: false }] }], position: [{ type: i0.Input, args: [{ isSignal: true, alias: "position", required: false }] }] } });
...
class FaLayersTextComponent {
    ...
    title = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "title" }] : /* istanbul ignore next */ []));
    flip = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "flip" }] : /* istanbul ignore next */ []));
    size = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "size" }] : /* istanbul ignore next */ []));
    pull = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "pull" }] : /* istanbul ignore next */ []));
    border = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "border" }] : /* istanbul ignore next */ []));
    inverse = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "inverse" }] : /* istanbul ignore next */ []));
    rotate = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "rotate" }] : /* istanbul ignore next */ []));
    fixedWidth = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "fixedWidth" }] : /* istanbul ignore next */ []));
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FaLayersTextComponent, decorators: [{
        ...
        }], ctorParameters: () => [], propDecorators: { content: [{ type: i0.Input, args: [{ isSignal: true, alias: "content", required: true }] }], title: [{ type: i0.Input, args: [{ isSignal: true, alias: "title", required: false }] }], flip: [{ type: i0.Input, args: [{ isSignal: true, alias: "flip", required: false }] }], size: [{ type: i0.Input, args: [{ isSignal: true, alias: "size", required: false }] }], pull: [{ type: i0.Input, args: [{ isSignal: true, alias: "pull", required: false }] }], border: [{ type: i0.Input, args: [{ isSignal: true, alias: "border", required: false }] }], inverse: [{ type: i0.Input, args: [{ isSignal: true, alias: "inverse", required: false }] }], rotate: [{ type: i0.Input, args: [{ isSignal: true, alias: "rotate", required: false }] }], fixedWidth: [{ type: i0.Input, args: [{ isSignal: true, alias: "fixedWidth", required: false }] }], transform: [{ type: i0.Input, args: [{ isSignal: true, alias: "transform", required: false }] }] } });

class FontAwesomeModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FontAwesomeModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.5", ngImport: i0, type: FontAwesomeModule, imports: [FaIconComponent,
    ...
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FontAwesomeModule });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: FontAwesomeModule, decorators: [{
            type: NgModule,
            args: [{
                    imports: [
                        FaIconComponent,
